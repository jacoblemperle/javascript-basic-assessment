...
var bob = {};
	bob.height = '6ft';
	bob.age = 24;
	bob.hair = {style: 'spikey', color: 'brown'};
...
var firstHero = heroes.shift(firstHero);
...
function removeItem(arr, str) {
	...
	removeItem(['A', 'B', 'C', 'B', 'D', 'A', 'A', 'B', 'B', 'B'], 'C');
...
// repeats strings. example 4->8, 2.5->5, 'Awesome'->'AwesomeAwesome'
	...
	function doubleTheFun(doub){
		var verifyLetter = new RegExp('/^[0-9a-zA-Z]+$/');
		if(doub == verifyLetter){
			doub = doub+doub;
		}else {
			doub = doub * 2;
		}
...
*/
	function outside(temperature, humidity, cloudiness){
		...
		}else if (temperature > 80 && cloudiness > 50) {
